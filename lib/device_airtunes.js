...
function AirTunesDevice(host, audioOut, options) {
  ...
  this.volscale = options.volscale || 1;
...
AirTunesDevice.prototype.setVolume = function(volume, callback) {
  this.rtsp.setVolume(volume*this.volscale, callback);
};
...
AirTunesDevice.prototype.setTrackLength = function(length, callback) {
  this.rtsp.setTrackLength(length, callback);
};
...
AirTunesDevice.prototype.setProgress = function(progress, callback) {
  this.rtsp.setProgress(progress, callback);
};
